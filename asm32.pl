...
local %mem;
%opmap = (
    ADD   => {FMT=> "RD,RS1,RS2",  IWORD=>"0000 RD   RS1  RS2  000000000000 0000"},
    SUB   => {FMT=> "RD,RS1,RS2",  IWORD=>"0000 RD   RS1  RS2  000000000000 0001"},
    AND   => {FMT=> "RD,RS1,RS2",  IWORD=>"0000 RD   RS1  RS2  000000000000 0100"},
    OR    => {FMT=> "RD,RS1,RS2",  IWORD=>"0000 RD   RS1  RS2  000000000000 0101"},
    XOR   => {FMT=> "RD,RS1,RS2",  IWORD=>"0000 RD   RS1  RS2  000000000000 0110"},
    NAND  => {FMT=> "RD,RS1,RS2",  IWORD=>"0000 RD   RS1  RS2  000000000000 1100"},
    NOR   => {FMT=> "RD,RS1,RS2",  IWORD=>"0000 RD   RS1  RS2  000000000000 1101"},
    NXOR  => {FMT=> "RD,RS1,RS2",  IWORD=>"0000 RD   RS1  RS2  000000000000 1110"},
    ADDI  => {FMT=> "RD,RS1,Imm",  IWORD=>"1000 RD   RS1  0000               Imm"},
    SUBI  => {FMT=> "RD,RS1,Imm",  IWORD=>"1000 RD   RS1  0001               Imm"},
    ANDI  => {FMT=> "RD,RS1,Imm",  IWORD=>"1000 RD   RS1  0100               Imm"},
    ORI   => {FMT=> "RD,RS1,Imm",  IWORD=>"1000 RD   RS1  0101               Imm"},
    XORI  => {FMT=> "RD,RS1,Imm",  IWORD=>"1000 RD   RS1  0110               Imm"},
    NANDI => {FMT=> "RD,RS1,Imm",  IWORD=>"1000 RD   RS1  1100               Imm"},
    NORI  => {FMT=> "RD,RS1,Imm",  IWORD=>"1000 RD   RS1  1101               Imm"},
    NXORI => {FMT=> "RD,RS1,Imm",  IWORD=>"1000 RD   RS1  1110               Imm"},
    MVHI  => {FMT=> "RD,Imm",      IWORD=>"1000 RD   0000 1011             ImmHi"},
    LW    => {FMT=> "RD,Imm(RS1)", IWORD=>"1001 RD   RS1  0000               Imm"},
    SW    => {FMT=> "RS2,Imm(RS1)",IWORD=>"0101 0000 RS1  RS2                Imm"},
    F     => {FMT=> "RD,RS1,RS2",  IWORD=>"0010 RD   RS1  RS2  000000000000 0000"},
    EQ    => {FMT=> "RD,RS1,RS2",  IWORD=>"0010 RD   RS1  RS2  000000000000 0001"},
    LT    => {FMT=> "RD,RS1,RS2",  IWORD=>"0010 RD   RS1  RS2  000000000000 0010"},
    LTE   => {FMT=> "RD,RS1,RS2",  IWORD=>"0010 RD   RS1  RS2  000000000000 0011"},
    T     => {FMT=> "RD,RS1,RS2",  IWORD=>"0010 RD   RS1  RS2  000000000000 1000"},
    NE    => {FMT=> "RD,RS1,RS2",  IWORD=>"0010 RD   RS1  RS2  000000000000 1001"},
    GTE   => {FMT=> "RD,RS1,RS2",  IWORD=>"0010 RD   RS1  RS2  000000000000 1010"},
    GT    => {FMT=> "RD,RS1,RS2",  IWORD=>"0010 RD   RS1  RS2  000000000000 1011"},
    FI    => {FMT=> "RD,RS1,Imm",  IWORD=>"1010 RD   RS1  0000               Imm"},
    EQI   => {FMT=> "RD,RS1,Imm",  IWORD=>"1010 RD   RS1  0001               Imm"},
    LTI   => {FMT=> "RD,RS1,Imm",  IWORD=>"1010 RD   RS1  0010               Imm"},
    LTEI  => {FMT=> "RD,RS1,Imm",  IWORD=>"1010 RD   RS1  0011               Imm"},
    TI    => {FMT=> "RD,RS1,Imm",  IWORD=>"1010 RD   RS1  1000               Imm"},
    NEI   => {FMT=> "RD,RS1,Imm",  IWORD=>"1010 RD   RS1  1001               Imm"},
    GTEI  => {FMT=> "RD,RS1,Imm",  IWORD=>"1010 RD   RS1  1010               Imm"},
    GTI   => {FMT=> "RD,RS1,Imm",  IWORD=>"1010 RD   RS1  1011               Imm"},
    ...
    JAL   => {FMT=>"RD,Imm(RS1)",  IWORD=>"1011 RD   RS1  0000             ShImm"},
